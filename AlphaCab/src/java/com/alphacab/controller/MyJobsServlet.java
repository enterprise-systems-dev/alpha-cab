...
public class MyJobsServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        request.setAttribute("journeyList", userDao.getJourneysByRegistration((Driver)session.getAttribute("user")));
        
        Driver driver = (Driver)session.getAttribute("user");
        
        System.out.println(driver.getRegistration());
        
        RequestDispatcher view = request.getRequestDispatcher("WEB-INF/views/my_jobs.jsp");
