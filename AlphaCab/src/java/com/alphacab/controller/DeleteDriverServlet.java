...
public class DeleteDriverServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String driverToDelete = request.getParameter("selected-driver");
        ...
        //select driver
        User u = driverDao.findUserByID(Integer.parseInt(driverToDelete));
        
        //delete driver
        if(driverDao.deleteUser(u)) {
            request.setAttribute("message", "Driver deleted");
        } else {
            request.setAttribute("error", "Could not delete driver");
        }
